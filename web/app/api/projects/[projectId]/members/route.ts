...
export async function GET(
  ...
  try {
    ...
    console.log('[API Route] Fetching members for project:', projectId, { page, size, search });
    
    let url = `${process.env.PROJECT_SERVICE_URL}/projects/${projectId}/members?page=${page}&size=${size}`;
    if (search) {
